...
const Waitlist = () => {
  ...
  return (
    <div className="min-h-screen text-foreground selection:bg-primary/30 flex flex-col items-center justify-center p-6 relative overflow-hidden transition-colors duration-300">
