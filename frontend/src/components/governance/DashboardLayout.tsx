    ...
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      <div className="w-64 border-r border-border/60 bg-card/40 backdrop-blur-xl flex flex-col">
        ...
        <div className="p-4 border-t border-border space-y-4">
          ...
          <Link
            to="/governance/settings"
            className={cn(
              "flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors text-muted-foreground hover:bg-accent hover:text-accent-foreground"
            )}
          >
